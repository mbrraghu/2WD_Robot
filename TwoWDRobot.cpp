...
MDD3A::MDD3A(MODE mode, uint8_t M1_pinA, uint8_t M1_pinB, uint8_t M2_pinA, uint8_t M2_pinB){
  _mode = mode;
  motorPins[0] = M1_pinA; motorPins[1] = M1_pinB; motorPins[2] = M2_pinA; motorPins[3] = M2_pinB;
...
void obstacleAvoidanceRobot::runTheRobot(int obstacleDistance, int turnTime, int leftWheelSpeed = 50, int rightWheelSpeed = 50){
